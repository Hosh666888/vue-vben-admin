...
<script setup lang="ts">
  ...
  import { getQueryString } from '/@/mars3d/utils/mars-util';
  import { getDefaultContextMenu } from '/@/mars3d/utils/getDefaultContextMenu';
  import { $alert, $message } from '/@/mars3d/components/mars-ui';
  ...
  onMounted(() => {
    console.log('map配置文件url', props.url);
    // 获取配置
